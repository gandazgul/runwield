...
export const loadPlanResetReviewArchiveScenario = {
    ...
    actions: [
        // Observe each command's result before submitting the next one: an idle
        // model does not mean the asynchronous slash command has finished.
        { type: "type", text: "/load-plan reset-held" },
        { type: "enter" },
        { type: "waitForScreen", text: "Plan reset to draft", timeoutMs: 12000 },
        { type: "waitForScriptedInteractions", remaining: 2, timeoutMs: 12000 },
        { type: "type", text: "/load-plan re-review" },
        { type: "enter" },
        { type: "waitForScreen", text: "Plan saved. Resume later with: wld resume re-review", timeoutMs: 60000 },
        { type: "waitForIdle", timeoutMs: 60000 },
        { type: "type", text: "/load-plan archive-me" },
        { type: "enter" },
        { type: "waitForScreen", text: "Archived archive-me to", timeoutMs: 12000 },
