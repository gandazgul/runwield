 ...
 *
 * Renders the Harns boot banner with the ASCII logo from logo.txt
 * centered on screen. The logo is tinted with the theme's "teal"
 * color. The square on the bottom right blinks like a cursor.
