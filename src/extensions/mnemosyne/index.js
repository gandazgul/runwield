...
- At the end of a session, store any relevant memories for future sessions.`;
  ...
  pi.registerTool({
    ...
    label: "Memory Recall",
    description:
      "Search project memory for relevant context, past decisions, and preferences.",
  ...
  pi.registerTool({
    ...
    label: "Memory Store",
    description:
      "Store a project memory. Set core=true for critical always-in-context memory.",
    promptSnippet:
      "Store a project-scoped memory (decision, preference, context)",
    promptGuidelines: [
  ...
  pi.registerTool({
    ...
    description:
      "Store a global memory. Set core=true for critical cross-project context.",
