...
behind the seam. The brief is independent of the user-facing problem-space explanation in Step 1. Give each of the three
agents a different design constraint:
