 ...
 * @property {(agentName: string, handler: import('../shared/session/types.js').AgentMessageHandler, uiAPI?: import('../shared/ui/types.js').UiAPI, agentModel?: string, options?: { allowReturnToRouter?: boolean }) => void} [setActiveAgent]
 * @property {(uiAPI: import('../shared/ui/types.js').UiAPI) => Promise<void>} [applyPendingRootSwap]
