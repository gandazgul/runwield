 ...
 *   2. It returns semantic handoff details containing the `reason` argument.
 *   3. SessionRuntime consumes the typed handoff result, switches to Router,
 *      and re-enters the turn with `reason` as Router's first user message —
