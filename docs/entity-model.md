...
| Worktree Registry          | Registry entry ID                             | `<primary-project>/.wld/internal/worktrees.json` under lock      | Worktree registry service                        | Local operational state ignored by Git.                                               |
