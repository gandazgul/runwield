...
const $$OnHold = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "WorkspaceLayout", $$WorkspaceLayout, { "title": "On-hold Plans \xB7 RunWield Workspace", "selectedTab": "on-hold", "url": Astro2.url.href }, { "default": async ($$result2) => renderTemplate`${error ? renderTemplate`${maybeRenderHead()}<section class="error-panel"> <h2>Plan Board failed to load</h2> <p>${error.error}</p> <p>${error.repair}</p> </section>` : renderTemplate`${renderComponent($$result2, "PlanBoard", PlanBoard, { "board": board, "view": "onHold", "url": Astro2.url.href, "client:load": true, "client:component-hydration": "load", "client:component-path": "/Users/gandazgul/Documents/web/harns/src/ui/workspace/components/Board.jsx", "client:component-export": "PlanBoard" })}`}` })}`;
}, "/Users/gandazgul/Documents/web/harns/src/ui/workspace/pages/on-hold.astro", void 0);

const $$file = "/Users/gandazgul/Documents/web/harns/src/ui/workspace/pages/on-hold.astro";
const $$url = "/on-hold";
